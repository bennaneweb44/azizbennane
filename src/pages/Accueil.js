    ...
    <div>
      <nav id="navbar" className="navbar navbar-expand-lg navbar-light bg-light navbar-secondary fixed-top p-2 simple-linear rounded bg-light" aria-label="Main navigation">
        <div className="container">
          <a className="navbar-brand logo-text" onClick={closeMenu} href="index.html"><i>Aziz BENNANE</i></a>
      ...
      <section className="home py-5 d-flex" id="home" >
        <div className="container text-light mt-5" data-aos="fade-right" style={{ paddingTop: '8em' }}>
            <h1 className="headline"><span className="home_text">Développeur full-stack</span></h1>
